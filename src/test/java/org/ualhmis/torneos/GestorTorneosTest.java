...
public class GestorTorneosTest {
    ...
    public void testCrearTorneo() {
        ...
        gestor.crearTorneo("Torneo Primavera", "Fútbol", "Sub-20", "Individual", "Clasificatorio");
        ...
        assertEquals("Sub-20", torneo.getCategoria());
        assertEquals("Individual", torneo.getModalidad());
        assertEquals("Clasificatorio", torneo.getTipo());
    }
